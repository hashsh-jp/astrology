...
export const metadata: Metadata = {
  ...
  description: '株式会社Astrologyへのお問い合わせは代表者のLINEから。動画生成AIに関するご相談、資料請求、導入相談など、お気軽にご連絡ください。',
};
              ...
              <div className="text-center space-y-6">
                ...
                <div>
                  ...
                  <p className="text-white/70 leading-relaxed">
                    以下のボタンから代表者のLINEを友だち追加して、<br className="hidden sm:block" />
                    お気軽にメッセージをお送りください。
                  </p>
                </div>
